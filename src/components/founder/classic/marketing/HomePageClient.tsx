          ...
          <div className="max-w-xl">
            ...
            >
              <Button asChild size="lg" className="gap-2">
                <Link href="/marketing/learn/modules">
                  Begin Your Journey <ArrowRight className="h-4 w-4" />
                </Link>
              </Button>
              <Button asChild variant="secondary" size="lg">
                <Link href="/marketing/learning-map">Explore the Map</Link>
              </Button>
            </motion.div>
          </div>
        </div>
          ...
          <Card className="glass-panel-strong max-w-2xl mx-auto">
            <CardContent className="p-6 sm:p-8 text-center space-y-4">
              ...
              <div className="flex flex-col sm:flex-row gap-3 justify-center">
                <Button asChild size="lg" className="gap-2">
                  <Link href="/marketing/learn/modules/what-marketing-is/what-marketing-actually-is">
                    Start Lesson 1 <ArrowRight className="h-4 w-4" />
                  </Link>
                </Button>
                <Button asChild variant="secondary" size="lg">
                  <Link href="/marketing/careers">Explore Career Paths</Link>
                </Button>
              </div>
            </CardContent>
          </Card>
