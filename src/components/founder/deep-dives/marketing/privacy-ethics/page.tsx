...
const PRIVACY_LAWS = [
  {
    ...
    marketingImpact: "Your email lists, CRM data, analytics tracking, and ad targeting all fall under this act. You need consent for direct marketing to individuals.",
  },
  {
    name: "GDPR (EU/UK)",
    ...
    marketingImpact: "If you have any EU customers or website visitors, GDPR applies. Cookie consent banners, email opt-in, and data deletion processes are mandatory.",
  },
  {
    ...
    marketingImpact: "Every email, every SMS, every automated message must comply. Penalties in Australia can reach $2.1M per day for serious breaches.",
  },
]
...
const COOKIE_CONSENT = [
  ...
  { type: "Marketing / Targeting", needsConsent: true, example: "Meta Pixel, Google Ads, retargeting cookies", impact: "Requires explicit opt-in. Without consent, retargeting and attribution break." },
...
const AI_ETHICS = [
  ...
  },
  {
    ...
    rule: "More data ≠ better marketing. Targeted, consented data outperforms mass surveillance every time.",
  },
  {
    ...
    <div className="container py-10 space-y-8">
      <div className="max-w-3xl">
        ...
        <h1 className="text-4xl sm:text-5xl font-serif font-bold text-editorial-ink leading-[0.95] tracking-tight">
          Privacy, Consent & Responsible AI
        </h1>
        <p className="text-editorial-muted mt-4 text-lg leading-relaxed max-w-2xl">
          Modern marketing runs on data. But data comes with legal obligations,
          ethical responsibilities, and the trust of real people. Understanding
          privacy and consent isn&apos;t optional — it&apos;s the foundation of sustainable
          marketing.
        </p>
      </div>
      ...
      <Card className="glass-panel-strong">
        <CardContent className="p-6 space-y-2">
          ...
          <p className="text-sm text-editorial-muted leading-relaxed max-w-3xl">
            A privacy breach can end a marketing career, destroy customer trust, and
            cost millions in fines. The Australian Privacy Act, GDPR, and spam laws
            aren&apos;t suggestions — they&apos;re legally enforceable. Marketers who understand
            ...
            <Card key={law.name}>
              <CardContent className="p-5 space-y-3">
                ...
                <div className="rounded-[12px] bg-editorial-amber-soft/60 border border-editorial-amber/10 px-3 py-2">
                  <p className="text-[10px] uppercase tracking-[0.12em] text-editorial-amber mb-0.5">Marketing impact</p>
                  <p className="text-xs text-editorial-ink/80">{law.marketingImpact}</p>
                </div>
              </CardContent>
            </Card>
          ))}
      ...
      {/* AI ethics */}
      <motion.section {...fadeIn} className="space-y-4">
        <h2 className="text-2xl font-serif font-bold text-editorial-ink">Responsible AI in marketing</h2>
        <p className="text-sm text-editorial-muted max-w-2xl">
          AI makes marketing faster and more powerful. That power comes with
      ...
      <Card className="glass-panel-strong">
        <CardContent className="p-6 text-center space-y-2">
          <p className="text-lg font-serif font-semibold text-editorial-ink">
            Trust is your most valuable marketing asset. Privacy is how you protect it.
          </p>
