...
const PRIVACY_LAWS = [
  {
    ...
    salesImpact: "Your email lists, CRM data, analytics tracking, and ad targeting all fall under this act. You need consent for direct sales to individuals.",
  },
  {
    name: "GDPR (EU/UK)",
    ...
    salesImpact: "If you have any EU customers or website visitors, GDPR applies. Cookie consent banners, email opt-in, and data deletion processes are mandatory.",
  },
  {
    ...
    salesImpact: "Every email, every SMS, every automated message must comply. Penalties in Australia can reach $2.1M per day for serious breaches.",
  },
]
...
const COOKIE_CONSENT = [
  ...
  { type: "Sales / Targeting", needsConsent: true, example: "Meta Pixel, Google Ads, retargeting cookies", impact: "Requires explicit opt-in. Without consent, retargeting and attribution break." },
...
const AI_ETHICS = [
  ...
  },
  {
    ...
    rule: "More data ≠ better sales. Targeted, consented data outperforms mass surveillance every time.",
  },
  {
    ...
    <div className="container py-10 space-y-8">
      <div className="max-w-3xl">
        ...
        <p className="text-editorial-muted mt-4 text-lg leading-relaxed max-w-2xl">
          Modern sales runs on data and relationships. Both come with legal
          obligations, ethical responsibilities, and the trust of real people.
          Ethical selling and trust-based relationships aren&apos;t optional —
          they&apos;re the foundation of sustainable revenue and long careers.
        </p>
      </div>
      ...
      <Card className="glass-panel-strong">
        <CardContent className="p-6 space-y-2">
          ...
          <p className="text-sm text-editorial-muted leading-relaxed max-w-3xl">
            A breach of trust can end a sales career, destroy customer relationships,
            and cost millions in lost deals. The Australian Privacy Act, GDPR, and spam
            laws apply to outbound sales too — they&apos;re legally enforceable. Salespeople
            who sell ethically build sustainable pipelines because buyers trust them,
            refer them, and expand with them.
          </p>
        </CardContent>
      </Card>
            ...
            <Card key={law.name}>
              <CardContent className="p-5 space-y-3">
                ...
                <div className="rounded-[12px] bg-editorial-amber-soft/60 border border-editorial-amber/10 px-3 py-2">
                  <p className="text-[10px] uppercase tracking-[0.12em] text-editorial-amber mb-0.5">Sales impact</p>
                  <p className="text-xs text-editorial-ink/80">{law.salesImpact}</p>
                </div>
              </CardContent>
            </Card>
          ))}
      ...
      {/* AI ethics */}
      <motion.section {...fadeIn} className="space-y-4">
        <h2 className="text-2xl font-serif font-bold text-editorial-ink">Responsible AI in sales</h2>
        <p className="text-sm text-editorial-muted max-w-2xl">
          AI makes sales faster and more powerful. That power comes with
      ...
      <Card className="glass-panel-strong">
        <CardContent className="p-6 text-center space-y-2">
          <p className="text-lg font-serif font-semibold text-editorial-ink">
            Trust is your most valuable sales asset. Ethics is how you protect it.
          </p>
          <p className="text-sm text-editorial-muted max-w-lg mx-auto">
            Buyers who trust you share more information, engage more deeply, close
            faster, expand more, and refer others. Ethical selling isn&apos;t a constraint
            — it&apos;s an investment in the relationships that make everything else work.
          </p>
        </CardContent>
      </Card>
    </div>
